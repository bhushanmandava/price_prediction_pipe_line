...
import pandas as pd
from src.outlier_evaluation import MainOutlierDetection, ZScoreOutlierDetection
...
def outlier_detection_step(
    ...
    outlier_detector = MainOutlierDetection(ZScoreOutlierDetection(threshold=3))
